        ...
        <div className="container">
          ...
          <Accordion type="single" collapsible className="max-w-3xl mx-auto">
            ...
            <AccordionItem value="item-4">
              ...
              <AccordionContent className="text-slate-700 leading-relaxed pt-4">
                Die Kosten hängen von Fassadengröße, Material, Verschmutzungsgrad und Zugänglichkeit ab. Durchschnittlich EUR 8-15 pro m². Gerne erstellen wir ein kostenloses Angebot.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
