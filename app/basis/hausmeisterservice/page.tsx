...
export default function Hausmeisterservice() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="Hausmeisterservice Ober- und Niederbayern - FIMI-Service Landshut"
        description="Professioneller Hausmeisterservice in Ober- und Niederbayern. Objektbetreuung, Kleinreparaturen und 24/7 Notfall-Service."
        keywords="Hausmeisterservice, Hausmeister Ober- und Niederbayern, Objektbetreuung, Facility Caretaker"
        url="/basis/hausmeisterservice"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-base sm:text-lg md:text-xl text-slate-600 leading-relaxed mb-8">
                Umfassende Objektbetreuung für Wohn- und Geschäftsimmobilien in Landshut, Regensburg, Freising und ganz Ober- und Niederbayern. Zuverlässig, kompetent und immer erreichbar.
              </p>
            ...
            <div className="relative">
              <ParallaxImage 
                src="/hausmeisterservice-hero.jpg" 
            ...
            <TabsContent value="leistungen" className="space-y-6">
              <Card className="p-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-bold text-lg mb-3 text-secondary">Regelmäßige Aufgaben</h4>
