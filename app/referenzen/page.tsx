        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-base sm:text-lg md:text-xl text-slate-600 leading-relaxed">
              Über 500 zufriedene Kunden in Landshut, Regensburg und Freising vertrauen auf unsere Expertise. Entdecken Sie, wie wir Unternehmen zu makelloser Sauberkeit verholfen haben.
            </p>
          </div>
        </div>
      </section>
