  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        ...
        keywords="Baureinigung, Bauschlussreinigung, Baustellenreinigung Deutschland, Endreinigung Neubau"
        url="/business/baureinigung"
        ...
        <div className="container">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-slate-600 text-xs sm:text-sm md:text-base">Professionelle Baureinigung nach Deutschlander Standards</p>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-primary/10 text-primary rounded-full mb-4">
