    ...
    <div className="min-h-screen bg-white">
      ...
      <article className="pt-32 pb-20">
        <div className="container max-w-4xl">
          ...
          <ParallaxImage 
                src="/blog-gebaeudereinigung.jpg" 
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <Tabs defaultValue="standards" className="mb-12">
              ...
              <TabsContent value="technologie" className="mt-6">
                <Card className="p-6 hover-lift hover-tilt hover-tilt">
                  <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-4">Moderne Technologie</h3>
                  <p className="text-slate-700 mb-4">
              ...
              <TabsContent value="personal" className="mt-6">
                <Card className="p-6 hover-lift hover-tilt hover-tilt">
                  <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-4">Geschultes Personal</h3>
                  <p className="text-slate-700 mb-4">
            ...
            <Accordion type="single" collapsible className="mb-12">
              ...
              <AccordionItem value="item-2">
                <AccordionTrigger className="text-sm sm:text-base md:text-lg font-semibold">Grundreinigung</AccordionTrigger>
                <AccordionContent className="text-lg leading-relaxed text-slate-700 pt-4">
              ...
              <AccordionItem value="item-3">
                <AccordionTrigger className="text-sm sm:text-base md:text-lg font-semibold">Spezialreinigung</AccordionTrigger>
                <AccordionContent className="text-lg leading-relaxed text-slate-700 pt-4">
